...
function Header() {
    ...
    return <>
        <div className='container'>
            <div className='row '>
                <div className='col-lg-11 col-sm-3 col-6 col-md-3 fluid'>
                    <Navbar collapseOnSelect expand="lg" fixed='top' className='top'>
                        <Navbar.Brand href="/" className=' fw-bolder fs-4  port '  style={{"color":"#B530D9"}}>PORTFOLIO</Navbar.Brand>
                        ...
                        <Navbar.Collapse id="responsive-navbar-nav">
                            ...
                            <Nav className='link1'>
                                ...
                                <h4 className='h5 follow' style={{"color":"#B530D9"}}>Follow Us </h4>
                                ...
                                {/* <a className='link 'style={{"marginTop":"-3px"}}><img src={facebook} className='fb'/>Facebook</a> */}
